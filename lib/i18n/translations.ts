...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    sqd3_q: "SQD3. My transaction, including steps and payment, was simple and convenient.",
  ...
  tl: {
    ...
    sqd3_q: "SQD3. Ang aking transaksyon, kabilang ang mga hakbang at bayad, ay simple at maginhawa.",
