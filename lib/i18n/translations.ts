...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    msg_service_pick_category_first: "Select a type of transaction or service above first.",
  ...
  tl: {
    ...
    msg_service_pick_category_first: "Piliin muna ang uri ng transaksyon o serbisyo sa itaas.",
