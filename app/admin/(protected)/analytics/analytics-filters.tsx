...
import { MONTH_NAMES, QUARTER_LABELS, type AnalyticsPeriodType } from "@/lib/reports/constants";
...
export function AnalyticsFilters({
  ...
  function changeType(nextType: AnalyticsPeriodType) {
    ...
    const now = new Date();
    const defaultPeriod =
      nextType === "MONTH" ? now.getMonth() + 1 : nextType === "QUARTER" ? Math.floor(now.getMonth() / 3) + 1 : 0;
